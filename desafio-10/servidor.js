...
import { contenedorProductosTest } from './contenedorProductosTest.js'
import { routerProductos } from './routerProductos.js'

server.use('/productos', routerProductos)
server.get("/productos-test",async (req, res) => {
    res.render("test", {mensaje: 'Productos test', resultado: contenedorProductosTest});
});
